      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            ...
            @if( session()->get('logged_user_type') == 'admin')
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="not_found_pages_here"
              >
              <svg
              class="w-4 h-4 mr-3"
              aria-hidden="true"
              ...
              <li class="relative">
                ...
                >
                  <img
                    ...
                    src="https://cdn.icon-icons.com/icons2/864/PNG/512/User_Avatar_Human_Profile_Face_Circle_icon-icons.com_67886.png"
                    alt=""
                    aria-hidden="true"
                  />
                </button>
                  ...
                  >
                    <li class="flex">
                      <a
                        ...
                        href="#"
                      >
                        <span>{{ session()->get('logged_username') }}</span>
                      </a>
                    </li>
                    <li class="flex">
                      <a
