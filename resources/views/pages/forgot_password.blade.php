        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <form action="{{url('forgot_pass')}}" method="POST" onsubmit="document.getElementById('sudmit').innerHTML ='Requesting###'; document.getElementById('sudmit').disabled = true;">
                  @if (Session::get('fail'))
                  ...
                  @if (Session::get('success'))
                    ...
                    <small style="color: green">You might need to check your spam folder. if mail is not received</small><br>
                  @endif
                  @csrf
