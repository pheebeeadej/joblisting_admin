      ...
      <div class="flex flex-col flex-1">
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            @endif
            <form enctype="multipart/form-data" method="POST" action="{{url('addjob')}}" onsubmit="document.getElementById('submit').disabled = true; document.getElementById('submit').innerHTML = 'Processing####'; ">
              @csrf
                <div
                ...
                >
                  <label class="block text-sm">
                    ...
                    <input type="text" name="jobname" value="{{old('jobname')}}" required
