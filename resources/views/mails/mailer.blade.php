...
<![endif]-->
      <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#30373b;background-color:#212674;width:100%;'>
        <tbody>
          <tr>
            <td>
              <div style='margin:0px auto;max-width:600px;'>
                          ...
                          <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                            <tr>
                              <td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#cad8e2;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:left;text-decoration:none;'>
                                  <strong>
                                   Thanks.
                                  </strong>
                                </div>
                    ...
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;'>
                            <p class="meta" style="text-align: left;"><span>{{ $details['date'] }}</span> </p>
                            <p style=" margin-bottom: -20px;"><h5 style="margin:0; font-size: 17px;  text-transform: uppercase; margin-bottom:2%;">{{ $details['title'] }} </h5></p>
                            <p style="text-align: justify;">Dear {{ $details['email'] }}.</p>
                            <p style="text-align: left;">{{ $details['message'] }}.</p>
                            <p style="text-align: left;"><a href="{{ $details['message2'] }}" style="color: red">{{ $details['message2'] }}</a></p>
                            <p style="text-align: left;">{{$details['message3']}}</p>
                        </div>
                      </td>
                    </tr>
                  </table>
                ...
                <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;'>
                         Warm regards from our Team. Visit our website <a href="#">click here</a> To learn more about us and enjoy our exclusive services. Thanks.
                         <img alt='Facebook' border='0' height='36' src='https://www.publicdomainpictures.net/pictures/180000/velka/blue-heart-14656901782rZ.jpg' style='display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; ' width='26' />
                        </div>
                      </td>
                    </tr>
                  </table>
